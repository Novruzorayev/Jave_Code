...
public class TruthTables {
	public static void main(String[] args) {
		...
		System.out.println("When true and true - reults is " +(true && true));
		...
		System.out.println("When false || false - resullt is " + (false || false));
		
		System.out.println();
		
		System.out.println("#### TRUTH TABLE FOR !(not) OPERATOR ####");
		System.out.println("When !true - reuslt is " +(!true));
