...
public class ArrayListDemo {
	public static void main(String[] args) {
		...
		greetings.add("Hello");//1
		greetings.add("Welcome");//2
		greetings.add("Hi");//3
		greetings.add("Bye");//4
		...
		greetings.add("How are you?");//5
		greetings.add("How are you?");//6
		greetings.add("How are you?");//7
		greetings.add("How are you?");//8
